...
if __name__ == "__main__":
    ...
    d = Downloader(public_api, auth_api_key, client)
    sample_down = SampleDownloader()
    uploader = Uploader(client, log_dir)

    # Submit file or whole directory with files for analysis
    if command['--submit']:
        # Submit whole directory for analysis
    ...
    # Download pcap files and reports from specified csv log file 
    ...
    # Download malware samples for specified family or families
    elif command['--get']:

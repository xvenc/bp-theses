...
Pro každý vzorek jsou provedeny dvě automatické dynamické analýzy (odkaz na kapitolu) ve dvou různých virtuálních prostředích. Jak lze vidět na obrázku \ref{Analysis_diagram} tak probíhájí dvě analýzy. První analýza je prováděno na virtuálním stroji, kde beží 
...
Každá analýza se sestáva z extrakce malware vzorku, ze zip archivu. A jeho následné spuštění v čistém prostředí. Poté je zaznamenávána veškerá síťová komunikace a také, jaké všechny procesy a programy se spustí.
\newpage
...
\begin{itemize}
    \item \textbf{csv}\footnote{\href{https://docs.python.org/3/library/csv.html}{https://docs.python.org/3/library/csv.html}}\\Pro usnadění práce s vytvořenými logovacími soubory
    \item \textbf{pathlib}\footnote{\href{https://docs.python.org/3/library/pathlib.html}{https://docs.python.org/3/library/pathlib.html}}\\Pro vytváření vnořených adresářů.
    \item \textbf{json}\footnote{\href{https://docs.python.org/3/library/json.html}{https://docs.python.org/3/library/json.html}}\\Knihovna pro k převodu slovníků na json formát.
\end{itemize}

...
Na obrázku \ref{pipeline} je znázorněno jednoduché schéma, jak vytvořený nástroj pracuje. Program nejprve stáhne odpovídající počet malware vzorků. Tyto vzorky jsou pak poslány na server k analýze.
...
\subsection*{Stahování malware vzorků}
\subsection*{Analýza stažených vzorků}
